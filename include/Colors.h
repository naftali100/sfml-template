...
// based on bootstrap's color scheme
const sf::Color Primary(0, 123, 255);
const sf::Color Secondary(108, 117, 125);
const sf::Color Success(40, 167, 69);
const sf::Color Danger(255, 193, 7);
const sf::Color Info(23, 162, 184);
